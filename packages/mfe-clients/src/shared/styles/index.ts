...
export const btn = {
  accent: { ...btnBase, padding: `${SPACING.sm} ${SPACING.lg}`, backgroundColor: COLORS.primary } as CSSProperties,
  success: { ...btnBase, padding: '10px 25px', backgroundColor: COLORS.success } as CSSProperties,
